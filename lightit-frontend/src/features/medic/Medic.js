...
import {getSymptoms, selectSymptoms} from "./medicSlice";
...
export function Medic() {
    ...
    const deleteSymptoms = () => {
        const aaa = document.getElementById(`selectedSymptoms`)
        console.log( aaa)
        debugger
    }
    const clearSymptoms = () => {
                ...
                <form>
                    <div className="shadow overflow-hidden sm:rounded-md">
                        <div className="px-4 py-5 bg-white sm:p-6">
                            <div className="grid grid-cols-6 gap-6">
                                ...
                                <div className="col-span-6 sm:col-span-3">
                                    ...
                                    <input type="number" min={currentYear - 150} max={currentYear} name="birth-year"
                                           id="birth-year"
                                           className="mt-1 focus:ring-purple-500 focus:border-purple-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md"
                                           value={year}
                                ...
                                <div className="col-span-6 sm:col-span-4">
                                    ...
                                    <select name="selectedSymptoms" id="selectedSymptoms"
                                            className="overflow-auto mt-1 focus:ring-purple-500 focus:border-purple-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md"
                                            multiple
                                    >
                                        {Object.keys(symptoms).length ?
                                            Object.values(symptoms)
                                                ...
                                                .map(s => <option value={s.ID}
                                                                  label={s.Name}>{s.Name}</option>) :
                                            <option label="Select symptom" disabled>Select symptom</option>}
                                    </select>
                                </div>
                                ...
                                <div className="col-span-6 sm:col-span-2">
                                    ...
                                    { Object.keys(symptoms).length ? <button
                        ...
                        <div className="px-4 py-3 bg-gray-50 text-right sm:px-6">
                            ...
                            <button type="button"
                                    className="inline-flex justify-center py-2 px-4 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-purple-600 hover:bg-purple-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-purple-500">Send
                            </button>
                        </div>
                    </div>
                </form>
